var Dial = function(container) {
    ...
    // ✅ NEW: get color from HTML data attribute (default: #78F8EC)
    this.textColor = this.container.dataset.color || '#78F8EC';
...
Dial.prototype.createText = function() {
    ...
    // ✅ Set color dynamically from HTML
...
// var containers = document.getElementsByClassName("chart-1");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-2");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-3");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-4");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-5");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-6");
// var dial = new Dial(containers[0]);
// dial.animateStart();
// var containers = document.getElementsByClassName("chart-7");
// var dial = new Dial(containers[0]);
// dial.animateStart();


function startDialAnimation(skillWrapper) {
    var containers = document.getElementsByClassName(skillWrapper)[0];
    if (containers) {
...
function observeDial(skillWrapper) {
    var containers = document.getElementsByClassName(skillWrapper)[0];
    ...
    var observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                startDialAnimation(skillWrapper);
